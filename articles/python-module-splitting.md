...
```mermaid
%%{init: {'theme':'default', 'themeVariables': {'background':'#ffffff','mainBkg':'#ffffff','secondaryBkg':'#ffffff','tertiaryBkg':'#ffffff','noteBkgColor':'#ffffff','textColor':'#212121','titleColor':'#212121','pieStrokeColor':'#ffffff','pieStrokeWidth':'2px','pieOuterStrokeWidth':'2px'}}}%%
