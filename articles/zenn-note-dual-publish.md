---
title: "ZennとNoteに同時投稿するGitHub Actions自動化パイプライン"
emoji: "⚙️"
type: "tech"
topics: ["githubactions", "zenn", "note", "playwright", "automation"]
published: false
status: "draft"
...
noteのエディタはリッチテキストベースです。Markdownを直接貼り付けることはできますが、コードブロックのシンタックスハイライトや独自記法（Zennの`:::message`等）はそのままでは表示されません。HTML変換を挟む必要がある。
