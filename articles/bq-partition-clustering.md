...
「なぜこんなにコストがかかっているのか」と調べると、多くの場合は毎回テーブル全体をスキャンしているフルスキャンが原因です。100GBのテーブルを1日100回クエリするだけで、月間の処理量は約300TBに達。BigQuery のオンデマンド料金は1TBあたり $6.25 ですので、その分のコストは約 $1,875 にもなります。
